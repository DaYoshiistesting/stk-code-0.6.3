...
public:
    ...
    enum SFXType
    {
        ...
        SOUND_SHOT, SOUND_GOO, SOUND_WEE, SOUND_EXPLOSION, SOUND_BZZT, SOUND_BEEP, SOUND_BEEP_AI,
        SOUND_BACK_MENU, SOUND_USE_ANVIL, SOUND_USE_PARACHUTE, SOUND_SELECT_MENU, SOUND_MOVE_MENU, 
        SOUND_FULL, SOUND_PRESTART, SOUND_START, SOUND_ENGINE_SMALL, SOUND_ENGINE_LARGE,
        NUM_SOUNDS, 
    };
